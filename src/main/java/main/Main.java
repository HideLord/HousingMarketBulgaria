...
public class Main {
	...
	static final String PLOVDIV_NEW = "https://www.imoti.com/prodazhbi/grad-plovdiv/dvustaini/page-";
	...
	static void run() {
		try {
			List<House> houses = parsePages(PLOVDIV_NEW, new ImotiComParser(), 100);
